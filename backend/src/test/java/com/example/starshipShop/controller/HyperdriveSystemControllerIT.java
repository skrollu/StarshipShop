...
public class HyperdriveSystemControllerIT {
    ...
    void createMinimalHyperdriveSystem_whenAuthenticatedAsAdmin_shouldWorksThroughAllLayers() throws Exception {        
    ...
    void updateHyperdriveSystem_whenAuthenticatedAsAdmin_shouldWorksThroughAllLayers() throws Exception {        
    ...
    void deleteHyperdriveSystem_whenAuthenticatedAsAdmin_shouldWorksThroughAllLayers() throws Exception {        
    ...
    void deleteHyperdriveSystem_whenAuthenticatedAsAdmin_shouldThrowsClientError() throws Exception {        
