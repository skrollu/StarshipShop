...
public class StarshipControllerIT {
    ...
    void updateStarship_whenAuthenticatedAsAdmin_shouldWorks() throws Exception {        
        ...
        mockMvc	.perform(put(BASE_URL + "/" + "mbLbXp35").with(httpBasic(ADMIN_USERNAME, ADMIN_PASSWORD))	.contentType(APPLICATION_JSON_UTF8)
        .content(json))
    ...
    void updateStarship_whenAuthenticatedAsUser_shouldWorks() throws Exception {        
        ...
        mockMvc	.perform(put(BASE_URL + "/" + "mbLbXp35").with(httpBasic(USER_USERNAME, USER_PASSWORD))	.contentType(APPLICATION_JSON_UTF8)
        .content(json))
        .andExpect(status().isForbidden());
    }
    ...
    void deleteStarship_whenAuthenticatedAsAdmin_shouldWorksThroughAllLayers() throws Exception {        
        mockMvc	.perform(delete(BASE_URL + "/{id}", "GELQkpdQ").with(httpBasic(ADMIN_USERNAME, ADMIN_PASSWORD)).contentType(APPLICATION_JSON_UTF8))
